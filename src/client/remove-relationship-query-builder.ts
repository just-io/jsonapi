...
export default class RemoveRelationshipQueryBuilder<
...
> {
    ...
    include<ID extends ResourceDeclaration>(
        relationship: string,
    ): RemoveRelationshipQueryBuilder<D, R, C, P, M, [...I, ID]>;
    include<ID extends ResourceDeclaration, K extends keyof ID['attributes'] | keyof ID['relationships']>(
        relationship: string,
        type: ID['type'],
        ...fields: K[]
    ): RemoveRelationshipQueryBuilder<D, R, C, P, M, [...I, PartialResourceDeclaration<ID, K>]>;
    include<ID extends ResourceDeclaration, K extends keyof ID['attributes'] | keyof ID['relationships']>(
        relationship: string,
        type?: ID['type'],
        ...fields: K[]
    ): RemoveRelationshipQueryBuilder<D, R, C, P, M, [...I, ID]> {
        const query = new RemoveRelationshipQueryBuilder<D, R, C, P, M, [...I, ID]>(
            this.#query.ref.type,
            this.#query.ref.id,
